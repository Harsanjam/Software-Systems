...
//Initialize the instance variables
    ...
    public ComplexNumber negate() {
        return new ComplexNumber(-1*this.getReal(), -1*this.getImaginary()); //A stub: to be fixed
    }
    ...
    public ComplexNumber add(ComplexNumber z) {
       ...
       return new ComplexNumber(this.getReal() + z.getReal(),this.getImaginary() + z.getImaginary() );
       	//A stub: to be fixed
    }
